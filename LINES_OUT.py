...
MINTEMP = 24
#MINTEMP = float(input("Add Min Temperature: "))

#high range of the sensor (this will be red on the screen)
MAXTEMP = 28
#MAXTEMP =float(input("Add Max Temperature: "))

#BREAK = int(input("Time break in sec: "))
...
#   my_array=np.array(Matrix)
   ...
   # cor_ij_min = coordinate_min(my_array1)
    ...
    #heat_map = sb.heatmap(my_array1)
    #plt.show()

    temperature_raport(np.max(my_array1), np.min(my_array1),name)
    print ("Raport %i" % (i+1))
    i=i+1
    print("\n")
